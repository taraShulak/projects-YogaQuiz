...
{question: 'What is the system of nerves that connects chakras and is where energy flows through?',
  answer: ['Nadi', 'Ramayana', 'Upanishad'],
  rightAnswer: 'Nadi',
...
{question: ' What is the true meaning of yoga?',
  answer: ['Spiritual union', 'Attaining freedom', 'Physical health'],
  rightAnswer: 'Spiritual union',
  note: 'Yoga is not accurately represented in Western culture. Returning back to the very first question, yoga does not mean physical health; it means spiritual union — or the union between body and mind.'
},
{question: 'Which of the following terms means freedom?',
  answer: ['Mukti', 'Dharma', 'Vedas'],
  rightAnswer: 'Mukti',
...
{question: 'What is the term used for ignorance?',
  answer: ['Maya', 'Samadhi', 'Daetin'],
  rightAnswer: 'Maya',
  note: 'Maya refers to the veil of ignorance covering the truth.'
},
{question: ' What are the Yamas?',
  answer: ['Moral and ethical rules or goals', 'The holy scriptures of Hinduism', 'Occult or psychic powers'],
  rightAnswer: 'Moral and ethical rules or goals',
  note: 'The Yamas are moral and ethical rules/goals set upon a person to commit to. The five aspects are: non-violence, truthfulness, non-stealing, bodily continence, and non-attachment to worldly possessions.'
},
{question: ' Where is the fourth chakra located?',
  answer: ['Spine', 'Heart', 'Brain' ],
  rightAnswer: 'Heart',
...
{question: ' Which type of yoga focuses primarily on exercise and physical techniques?',
  answer: ['Jnana yoga', 'Raja yoga', 'Hatha yoga'],
...
{question: 'What would not be helpful to do when meditating?',
  answer: ['Think of problems', 'Picture a peaceful place', 'Concentrate on a color'],
...
{question: ' What are the three things you need for a session of Bikram yoga?',
  answer: ['Mat / Book / Music', 'Mat / Towel / Water', 'Mat / Incense / Coffee'],
...
{question: 'What is one of the most important objectives during yoga?',
  answer: [ 'Physical strength', 'Flexibility', 'Correct breathing'],
...
{question: 'Bikram yoga is a form of what type of yoga?',
  answer: ['Hot yoga', 'Forrest yoga', 'Hatha yoga'],
...
{question: 'In what state of what country was the founder of Bikram yoga born?',
  answer: ['West Bengal, India', 'Jharkhand, India', 'Andhra Pradesh, India'],
...
{question: `What is not one of the four main types of yoga?`,
  answer: ['Forrest yoga', 'Bhakti yoga', 'Karma yoga'],
...
{question: 'Based upon Yoga philosophy, which of these are the two entities that make up the universe?',
  answer: ['Shiva & Dharma', 'Veda & Virne', 'Prakrti & Purusa'],
...
{question: 'What are Granthi knots?',
  answer: ['The first 3 composite chakras', 'The eye of Brahma', 'The knots of Nadi'],
...
{question: 'What is the practice in Kundalini where the meditator exits his physical form and enters some sort of astral state called?',
  answer: [`Siva’s breathing`, `Brahman’s gate`, `Death’s sleep`],
